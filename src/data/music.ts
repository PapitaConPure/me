		...
		downloadUrls: [
			{
				...
				label: 'Pista completa (320kbps)',
				size: '0 MB',
				url: '/audio/music/th20-prester-john-piano/The World is Made From Cuteness.mp3',
			},
			{
				kind: 'file',
				format: 'midi',
			...
			},
			{
				kind: 'video',
				format: 'mp4',
				label: 'Animación (Bucle) (h.264 / 4k@60fps)',
				size: '0 MB',
				url: '/video/music/th20-prester-john-piano/01_battle1_loop.mp4',
			},
			{
				kind: 'video',
				format: 'mov',
				label: 'Animación (Bucle) (DNxHR HQ / 4k@60fps)',
				size: '0 MB',
				url: '/video/music/th20-prester-john-piano/01_battle1_loop.mov',
			},
			{
				kind: 'file',
				format: 'zip',
		...
		downloadUrls: [
			{
				...
				label: 'Pista completa (320kbps)',
				size: '0 MB',
				url: '/audio/music/th20-nareko-piano/The World is Made From Cuteness.mp3',
			},
			{
				kind: 'file',
				format: 'midi',
			...
			},
			{
				...
				label: 'Animación (Bucle) (h.264 / 4k@60fps)',
				size: '0 MB',
				url: '/video/music/th20-nareko-piano/01_battle1_loop.mp4',
			},
			{
				kind: 'video',
				format: 'mov',
				label: 'Animación (Bucle) (DNxHR HQ / 4k@60fps)',
				size: '0 MB',
				url: '/video/music/th20-nareko-piano/01_battle1_loop.mov',
			},
			{
				kind: 'file',
				format: 'zip',
		...
		downloadUrls: [
			{
				...
				label: 'Pista completa (320kbps)',
				size: '0 MB',
				url: '/audio/music/th20-title-piano/The World is Made From Cuteness.mp3',
			},
			{
				kind: 'file',
				format: 'midi',
			...
			},
			{
				...
				label: 'Animación (Bucle) (h.264 / 4k@60fps)',
				size: '0 MB',
				url: '/video/music/th20-title-piano/01_battle1_loop.mp4',
			},
			{
				kind: 'video',
				format: 'mov',
				label: 'Animación (Bucle) (DNxHR HQ / 4k@60fps)',
				size: '0 MB',
				url: '/video/music/th20-title-piano/01_battle1_loop.mov',
			},
			{
				kind: 'file',
				format: 'zip',
