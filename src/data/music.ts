		...
		downloadUrls: [
			...
			},
			{
				...
				label: {
					...
					ja: 'アニメーション - タイトル (Loop) (h.264 1080p@60)',
				},
				size: '40.4 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Canal of Willows (Bucle) (h.264 1080p@60)',
					en: 'Animation - Canal of Willows (Loop) (h.264 1080p@60)',
					ja: 'アニメーション - Canal of Willows (Loop) (h.264 1080p@60)',
				},
				size: '9.07 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Untrodden Valley (Bucle) (h.264 1080p@60)',
					en: 'Animation - Untrodden Valley (Loop) (h.264 1080p@60)',
					ja: 'アニメーション - Untrodden Valley (Loop) (h.264 1080p@60)',
				},
				size: '23.3 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Moriya Shrine Inner Sanctum (Bucle) (h.264 1080p@60)',
					en: 'Animation - Moriya Shrine Inner Sanctum (Loop) (h.264 1080p@60)',
					ja: 'アニメーション - Moriya Shrine Inner Sanctum (Loop) (h.264 1080p@60)',
				},
				size: '25.0 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Forest of Magic (Bucle) (h.264 1080p@60)',
					en: 'Animation - Forest of Magic (Loop) (h.264 1080p@60)',
					ja: 'アニメーション - Forest of Magic (Loop) (h.264 1080p@60)',
				},
				size: '10.9 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Foot of the Youkai Mountain (Bucle) (h.264 1080p@60)',
					en: 'Animation - Foot of the Youkai Mountain (Loop) (h.264 1080p@60)',
					ja: 'アニメーション - Foot of the Youkai Mountain (Loop) (h.264 1080p@60)',
				},
				size: '23.6 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Youkai Mountain Hills (Bucle 1) (h.264 1080p@60)',
					en: 'Animation - Youkai Mountain Hills (Loop 1) (h.264 1080p@60)',
					ja: 'アニメーション - Youkai Mountain Hills (Loop 1) (h.264 1080p@60)',
				},
				size: '4.47 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Youkai Mountain Hills (Transición 1→2) (h.264 1080p@60)',
					en: 'Animation - Youkai Mountain Hills (Transition 1→2) (h.264 1080p@60)',
					ja: 'アニメーション - Youkai Mountain Hills (Transition 1→2) (h.264 1080p@60)',
				},
				size: '5.77 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Youkai Mountain Hills (Bucle 2) (h.264 1080p@60)',
					en: 'Animation - Youkai Mountain Hills (Loop 2) (h.264 1080p@60)',
					ja: 'アニメーション - Youkai Mountain Hills (Loop 2) (h.264 1080p@60)',
				},
				size: '6.00 MB',
			...
			},
			{
				...
				label: {
					...
					ja: 'アニメーション - Higan (Loop) (h.264 1080p@60)',
				},
				size: '45.4 MB',
			...
			},
			{
				...
				label: {
					...
					ja: 'アニメーション - Sai no Kawara (Loop) (h.264 1080p@60)',
				},
				size: '15.7 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Hell of Blood Pools (Bucle) (h.264 1080p@60)',
					en: 'Animation - Hell of Blood Pools (Loop) (h.264 1080p@60)',
					ja: 'アニメーション - Hell of Blood Pools (Loop) (h.264 1080p@60)',
				},
				size: '7.04 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Greater Hell (Bucle 1) (h.264 1080p@60)',
					en: 'Animation - Greater Hell (Loop 1) (h.264 1080p@60)',
					ja: 'アニメーション - Greater Hell (Loop 1) (h.264 1080p@60)',
				},
				size: '7.87 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Greater Hell (Transición 1→2) (h.264 1080p@60)',
					en: 'Animation - Greater Hell (Transition 1→2) (h.264 1080p@60)',
					ja: 'アニメーション - Greater Hell (Transition 1→2) (h.264 1080p@60)',
				},
				size: '10.3 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Greater Hell (Bucle 2) (h.264 1080p@60)',
					en: 'Animation - Greater Hell (Loop 2) (h.264 1080p@60)',
					ja: 'アニメーション - Greater Hell (Loop 2) (h.264 1080p@60)',
				},
				size: '12.2 MB',
			...
			},
			{
				...
				format: 'mp4',
				label: {
					es: 'Animación - Hell (Bucle) (h.264 1080p@60)',
					en: 'Animation - Hell (Loop) (h.264 1080p@60)',
					ja: 'アニメーション - Hell (Loop) (h.264 1080p@60)',
				},
				size: '83.21 MB',
		...
		downloadUrls: [
			...
			},
			{
				...
				label: {
					...
					ja: 'アニメーションパック (Stage 3 animation included) (archive.org)',
				},
				size: '5.30 GB',
